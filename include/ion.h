...
#define ION_EXYNOS_DRM_FIMD_VIDEO_MASK  (1 << 27)
#define ION_EXYNOS_DRM_GSC_MASK         (1 << 26)
#define ION_EXYNOS_DRM_MFC_SECURE_MASK  (1 << 25)
#define ION_HEAP_EXYNOS_DRM_FIMD_VIDEO_MASK    (ION_HEAP_EXYNOS_CONTIG_MASK|ION_EXYNOS_DRM_FIMD_VIDEO_MASK)
#define ION_HEAP_EXYNOS_DRM_GSC_MASK           (ION_HEAP_EXYNOS_CONTIG_MASK|ION_EXYNOS_DRM_GSC_MASK)
#define ION_HEAP_EXYNOS_DRM_MFC_SECURE_MASK    (ION_HEAP_EXYNOS_CONTIG_MASK|ION_EXYNOS_DRM_MFC_SECURE_MASK)
